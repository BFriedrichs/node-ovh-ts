...
class DbaasLogsHandler {
  ...
  addLogsTokenByServiceName = (
    ...
    return this.ovh.request('POST', `/dbaas/logs/${serviceName}/token`, body);
  };
  ...
  deleteLogsTokenByServiceNameAndTokenId = (
    ...
    return this.ovh.request('DELETE', `/dbaas/logs/${serviceName}/token/${tokenId}`);
  };
  ...
  getLogsTokenByServiceNameAndTokenId = (
    ...
    return this.ovh.request('GET', `/dbaas/logs/${serviceName}/token/${tokenId}`);
  };
  ...
  postLogsUserChangePasswordByServiceName = (
    ...
    return this.ovh.request('POST', `/dbaas/logs/${serviceName}/user/changePassword`, body);
  };
}
