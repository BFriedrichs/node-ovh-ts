...
class DedicatedServerHandler {
  ...
  getServerStatisticsRaidByServiceNameAndUnit = (
    ...
    return this.ovh.request('GET', `/dedicated/server/${serviceName}/statistics/raid/${unit}`);
  };
  ...
  getServerStatisticsRaidVolumeByServiceNameAndUnitAndVolume = (
    ...
    unit: string,
    volume: string
  ): Promise<DedicatedServerRtmRaidVolume> => {
    return this.ovh.request(
      'GET',
  ...
  getServerStatisticsRaidVolumePortByServiceNameAndUnitAndVolumeAndPort = (
    ...
    unit: string,
    volume: string
  ): Promise<DedicatedServerRtmRaidVolumePort> => {
    return this.ovh.request(
      'GET',
  ...
  getServerTaskByServiceNameAndTaskId = (
    ...
    return this.ovh.request('GET', `/dedicated/server/${serviceName}/task/${taskId}`);
  };
  ...
  addServerVirtualMacByServiceName = (
    ...
    return this.ovh.request('POST', `/dedicated/server/${serviceName}/virtualMac`, body);
  };
  ...
  getServerVirtualMacByServiceNameAndMacAddress = (
    ...
    return this.ovh.request('GET', `/dedicated/server/${serviceName}/virtualMac/${macAddress}`);
  };
  ...
  getServerVirtualMacVirtualAddressByServiceNameAndMacAddressAndIpAddress = (
    ...
    macAddress: string,
    serviceName: string
  ): Promise<DedicatedServerVirtualMacManagement> => {
    return this.ovh.request(
      'GET',
      `/dedicated/server/${serviceName}/virtualMac/${macAddress}/virtualAddress/${ipAddress}`
    );
  ...
  getServerVrackByServiceNameAndVrack = (
    ...
    return this.ovh.request('GET', `/dedicated/server/${serviceName}/vrack/${vrack}`);
  };
