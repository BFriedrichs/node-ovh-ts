...
class MeHandler {
  ...
  postIncidentSbgMigrateServices = (body: MeIncidentMigrateServices): Promise<MeIncidentOrder> => {
    return this.ovh.request('POST', '/me/incident/sbg/migrateServices', body);
  };

  /** Get your insight access token */
  getInsight = (): Promise<InsightAccess> => {
    return this.ovh.request('GET', '/me/insight');
  };
  ...
  createInstallationTemplate = (body: {
    ...
    return this.ovh.request('POST', '/me/installationTemplate', body);
  };
  ...
  updateInstallationTemplateByTemplateName = (
    ...
    return this.ovh.request('PUT', `/me/installationTemplate/${templateName}`, body);
  };
  ...
  updateInstallationTemplatePartitionSchemeHardwareRaidByTemplateNameAndSchemeNameAndName = (
    ...
    schemeName: string,
    templateName: string,
    body: DedicatedInstallationTemplateHardwareRaid
  ): Promise<void> => {
    return this.ovh.request(
      'PUT',
      `/me/installationTemplate/${templateName}/partitionScheme/${schemeName}/hardwareRaid/${name}`,
  ...
  updateInstallationTemplatePartitionSchemePartitionByTemplateNameAndSchemeNameAndMountpoint = (
    ...
    schemeName: string,
    templateName: string,
    body: DedicatedInstallationTemplateTemplatePartitions
  ): Promise<void> => {
    return this.ovh.request(
      'PUT',
      `/me/installationTemplate/${templateName}/partitionScheme/${schemeName}/partition/${mountpoint}`,
  ...
  addIpOrganisation = (body: {
    ...
    return this.ovh.request('POST', '/me/ipOrganisation', body);
  };
  ...
  updateIpOrganisationByOrganisationId = (
    ...
    return this.ovh.request('PUT', `/me/ipOrganisation/${organisationId}`, body);
  };
  ...
  addIpxeScript = (body: {
    ...
    name: string;
    script: string;
  }): Promise<NichandleIpxe> => {
    return this.ovh.request('POST', '/me/ipxeScript', body);
  };
  ...
  postMailingListSubscribe = (body: { email: string; mailingList: string }): Promise<void> => {
    return this.ovh.request('POST', '/me/mailingList/subscribe', body);
  };
  ...
  getMigrationContractByMigrationIdAndContractId = (
    ...
    return this.ovh.request('GET', `/me/migration/${migrationId}/contract/${contractId}`);
  };
  ...
  postMigrationContractAcceptByMigrationIdAndContractId = (
    ...
    return this.ovh.request('POST', `/me/migration/${migrationId}/contract/${contractId}/accept`);
  };
  ...
  getMigrationContractAgreementByMigrationIdAndContractId = (
    ...
    return this.ovh.request('GET', `/me/migration/${migrationId}/contract/${contractId}/agreement`);
  };
  ...
  postOrderBalanceByOrderId = (
    ...
    return this.ovh.request('POST', `/me/order/${orderId}/balance`, body);
  };
  ...
  getOrderBalanceByOrderIdAndBalanceName = (
    ...
    return this.ovh.request('GET', `/me/order/${orderId}/balance/${balanceName}`);
  };
  ...
  getOrderDebtOperationByOrderIdAndOperationId = (
    ...
    return this.ovh.request('GET', `/me/order/${orderId}/debt/operation/${operationId}`);
  };
  ...
  getOrderDetailsByOrderIdAndOrderDetailId = (
    ...
    return this.ovh.request('GET', `/me/order/${orderId}/details/${orderDetailId}`);
  };
  ...
  getOrderDetailsExtensionByOrderIdAndOrderDetailId = (
    ...
    return this.ovh.request('GET', `/me/order/${orderId}/details/${orderDetailId}/extension`);
  };
  ...
  postOrderPayByOrderId = (
    ...
    return this.ovh.request('POST', `/me/order/${orderId}/pay`, body);
  };
  ...
  postOrderPayWithRegisteredPaymentMeanByOrderId = (
    ...
    return this.ovh.request('POST', `/me/order/${orderId}/payWithRegisteredPaymentMean`, body);
  };
  ...
  postOrderRetractionByOrderId = (
    ...
    return this.ovh.request('POST', `/me/order/${orderId}/retraction`, body);
  };
  ...
  postOvhAccountCreditOrderByOvhAccountId = (
    ...
    return this.ovh.request('POST', `/me/ovhAccount/${ovhAccountId}/creditOrder`, body);
  };
  ...
  getOvhAccountMovementsByOvhAccountIdAndMovementId = (
    ...
    return this.ovh.request('GET', `/me/ovhAccount/${ovhAccountId}/movements/${movementId}`);
  };
  ...
  postOvhAccountRetrieveMoneyByOvhAccountId = (
    ...
    return this.ovh.request('POST', `/me/ovhAccount/${ovhAccountId}/retrieveMoney`, body);
  };

  /** Fetch the partner level of the account */
  getPartnerLevel = (): Promise<MePartnerLevelLevel> => {
    return this.ovh.request('GET', '/me/partnerLevel');
  };

  /** Request a password recover */
  postPasswordRecover = (body: {
    ovhCompany: NichandleOvhCompanyEnum;
    ovhId: string;
  }): Promise<void> => {
    return this.ovh.request('POST', '/me/passwordRecover', body);
  };
  ...
  postPaymentMethod = (body: MePaymentMethodCreation): Promise<MePaymentMethodValidation> => {
    return this.ovh.request('POST', '/me/payment/method', body);
  };
  ...
  updatePaymentMethodByPaymentMethodId = (
    ...
    return this.ovh.request('PUT', `/me/payment/method/${paymentMethodId}`, body);
  };
  ...
  postPaymentMethodChallengeByPaymentMethodId = (
    ...
    return this.ovh.request('POST', `/me/payment/method/${paymentMethodId}/challenge`, body);
  };
  ...
  addPaymentMethodDetailsByPaymentMethodId = (
    ...
    return this.ovh.request('POST', `/me/payment/method/${paymentMethodId}/details`, body);
  };
  ...
  postPaymentMethodFinalizeByPaymentMethodId = (
    ...
    return this.ovh.request('POST', `/me/payment/method/${paymentMethodId}/finalize`, body);
  };
  ...
  postPaymentMeanBankAccountChallengeById = (
    ...
    return this.ovh.request('POST', `/me/paymentMean/bankAccount/${id}/challenge`, body);
  };
  ...
  postPaymentMeanCreditCardChallengeById = (
    ...
    return this.ovh.request('POST', `/me/paymentMean/creditCard/${id}/challenge`, body);
  };
  ...
  updatePaymentMeanDeferredPaymentAccountById = (
    ...
    return this.ovh.request('PUT', `/me/paymentMean/deferredPaymentAccount/${id}`, body);
  };
  ...
  postPaymentMeanPaypalChallengeById = (
    ...
    return this.ovh.request('POST', `/me/paymentMean/paypal/${id}/challenge`, body);
  };
  ...
  /** Get this object properties */
  getRecommendations = (): Promise<RecommendationsRecommendations> => {
    return this.ovh.request('GET', '/me/recommendations');
  };
  ...
  getRefundDetailsByRefundIdAndRefundDetailId = (
    ...
    return this.ovh.request('GET', `/me/refund/${refundId}/details/${refundDetailId}`);
  };
  ...
  updateSubscriptionBySubscriptionType = (
    ...
    return this.ovh.request('PUT', `/me/subscription/${subscriptionType}`, body);
  };

  /** Fetch the support level of the account */
  getSupportLevel = (): Promise<MeSupportLevelLevel> => {
    return this.ovh.request('GET', '/me/supportLevel');
  };
  ...
  postTag = (body: MeTagCreation): Promise<MeTagTag> => {
    return this.ovh.request('POST', '/me/tag', body);
  };
  ...
  updateTaskDomainArgumentByIdAndKey = (
    ...
    return this.ovh.request('PUT', `/me/task/domain/${id}/argument/${key}`, body);
  };
  ...
  createTelephonyDefaultIpRestriction = (body: {
    ...
    return this.ovh.request('POST', '/me/telephony/defaultIpRestriction', body);
  };
  ...
  getTelephonySettings = (): Promise<TelephonySettings> => {
    return this.ovh.request('GET', '/me/telephony/settings');
  };
  ...
  getVipStatus = (): Promise<NichandleVipStatus> => {
    return this.ovh.request('GET', '/me/vipStatus');
  };

  /** Verify existing voucher */
  postVoucherCheckValidity = (body: { voucher: string }): Promise<NichandleVoucherStatus> => {
    return this.ovh.request('POST', '/me/voucher/checkValidity', body);
  };
  ...
  getWithdrawalDetailsByWithdrawalIdAndWithdrawalDetailId = (
    ...
    return this.ovh.request('GET', `/me/withdrawal/${withdrawalId}/details/${withdrawalDetailId}`);
  };
  ...
  getXdslSetting = (): Promise<XdslSetting> => {
    return this.ovh.request('GET', '/me/xdsl/setting');
  };
  ...
  updateXdslSetting = (body: {
    ...
    return this.ovh.request('POST', '/me/xdsl/setting', body);
  };
}
