...
class HostingWebHandler {
  ...
  getWebLocalSeoDirectoriesList = (): Promise<HostingWebLocalSeoDirectoriesList> => {
    return this.ovh.request('GET', '/hosting/web/localSeo/directoriesList');
  };
  ...
  checkWebLocalSeoVisibility = (body: {
    ...
    return this.ovh.request('POST', '/hosting/web/localSeo/visibilityCheck', body);
  };
  ...
  getWebOfferCapabilities = (): Promise<HostingWebCapabilities> => {
    return this.ovh.request('GET', '/hosting/web/offerCapabilities');
  };
  ...
  postWebActivatePrivateDatabaseByServiceName = (
    ...
    return this.ovh.request('POST', `/hosting/web/${serviceName}/activatePrivateDatabase`, body);
  };
  ...
  postWebAttachedDomainByServiceName = (
    ...
    return this.ovh.request('POST', `/hosting/web/${serviceName}/attachedDomain`, body);
  };
  ...
  deleteWebAttachedDomainByServiceNameAndDomain = (
    ...
    return this.ovh.request('DELETE', `/hosting/web/${serviceName}/attachedDomain/${domain}`);
  };
  ...
  getWebAttachedDomainByServiceNameAndDomain = (
    ...
    return this.ovh.request('GET', `/hosting/web/${serviceName}/attachedDomain/${domain}`);
  };
  ...
  updateWebAttachedDomainByServiceNameAndDomain = (
    ...
    return this.ovh.request('PUT', `/hosting/web/${serviceName}/attachedDomain/${domain}`, body);
  };
  ...
  postWebAttachedDomainRestartByServiceNameAndDomain = (
    ...
    return this.ovh.request('POST', `/hosting/web/${serviceName}/attachedDomain/${domain}/restart`);
  };
  ...
  getWebBoostHistoryByServiceNameAndDate = (
    ...
    return this.ovh.request('GET', `/hosting/web/${serviceName}/boostHistory/${date}`);
  };
  ...
  getWebCdnDomainByServiceNameAndDomainName = (
    ...
    return this.ovh.request('GET', `/hosting/web/${serviceName}/cdn/domain/${domainName}`);
  };
  ...
  getWebCdnDomainLogsByServiceNameAndDomainName = (
    ...
    return this.ovh.request('GET', `/hosting/web/${serviceName}/cdn/domain/${domainName}/logs`);
  };
  ...
  postWebCdnDomainPurgeByServiceNameAndDomainName = (
    ...
    return this.ovh.request('POST', `/hosting/web/${serviceName}/cdn/domain/${domainName}/purge`);
  };
  ...
  postWebCdnDomainRefreshByServiceNameAndDomainName = (
    ...
    return this.ovh.request('POST', `/hosting/web/${serviceName}/cdn/domain/${domainName}/refresh`);
  };
  ...
  updateWebCdnServiceInfosUpdateByServiceName = (
    ...
    return this.ovh.request('POST', `/hosting/web/${serviceName}/cdn/serviceInfosUpdate`, body);
  };
  ...
  updateWebConfigurationByServiceName = (
    ...
    return this.ovh.request('PUT', `/hosting/web/${serviceName}/configuration`, body);
  };
  ...
  confirmWebTerminationByServiceName = (
    ...
    return this.ovh.request('POST', `/hosting/web/${serviceName}/confirmTermination`, body);
  };
  ...
  createWebCronByServiceName = (
    ...
    return this.ovh.request('POST', `/hosting/web/${serviceName}/cron`, body);
  };
  ...
  updateWebCronByServiceNameAndId = (
    ...
    return this.ovh.request('PUT', `/hosting/web/${serviceName}/cron/${id}`, body);
  };
  ...
  postWebDatabaseByServiceName = (
    ...
    return this.ovh.request('POST', `/hosting/web/${serviceName}/database`, body);
  };
  ...
  deleteWebDatabaseByServiceNameAndName = (
    ...
    return this.ovh.request('DELETE', `/hosting/web/${serviceName}/database/${name}`);
  };
  ...
  getWebDatabaseByServiceNameAndName = (
    ...
    return this.ovh.request('GET', `/hosting/web/${serviceName}/database/${name}`);
  };
  ...
  getWebDatabaseCapabilitiesByServiceNameAndName = (
    ...
    return this.ovh.request('GET', `/hosting/web/${serviceName}/database/${name}/capabilities`);
  };
  ...
  postWebDatabaseDumpByServiceNameAndName = (
    ...
    return this.ovh.request('POST', `/hosting/web/${serviceName}/database/${name}/dump`, body);
  };
  ...
  deleteWebDatabaseDumpByServiceNameAndNameAndId = (
    ...
    return this.ovh.request('DELETE', `/hosting/web/${serviceName}/database/${name}/dump/${id}`);
  };
  ...
  getWebDatabaseDumpByServiceNameAndNameAndId = (
    ...
    name: string,
    serviceName: string
  ): Promise<HostingWebDatabaseDump> => {
    return this.ovh.request('GET', `/hosting/web/${serviceName}/database/${name}/dump/${id}`);
  };
  ...
  postWebDatabaseImportByServiceNameAndName = (
    ...
    return this.ovh.request('POST', `/hosting/web/${serviceName}/database/${name}/import`, body);
  };
  ...
  postWebDatabaseRequestByServiceNameAndName = (
    ...
    return this.ovh.request('POST', `/hosting/web/${serviceName}/database/${name}/request`, body);
  };
  ...
  postWebDatabaseRestoreByServiceNameAndName = (
    ...
    return this.ovh.request('POST', `/hosting/web/${serviceName}/database/${name}/restore`, body);
  };
  ...
  getWebDatabaseStatisticsByServiceNameAndName = (
    ...
    return this.ovh.request('GET', `/hosting/web/${serviceName}/database/${name}/statistics`);
  };
  ...
  postWebEmailRequestByServiceName = (
    ...
    return this.ovh.request('POST', `/hosting/web/${serviceName}/email/request`, body);
  };
  ...
  getWebEmailOptionByServiceNameAndId = (
    ...
    return this.ovh.request('GET', `/hosting/web/${serviceName}/emailOption/${id}`);
  };
  ...
  getWebEmailOptionServiceInfosByServiceNameAndId = (
    ...
    return this.ovh.request('GET', `/hosting/web/${serviceName}/emailOption/${id}/serviceInfos`);
  };
  ...
  postWebEnvVarByServiceName = (
    ...
    return this.ovh.request('POST', `/hosting/web/${serviceName}/envVar`, body);
  };
  ...
  updateWebEnvVarByServiceNameAndKey = (
    ...
    return this.ovh.request('PUT', `/hosting/web/${serviceName}/envVar/${key}`, body);
  };
  ...
  getWebExtraSqlPersoByServiceNameAndName = (
    ...
    return this.ovh.request('GET', `/hosting/web/${serviceName}/extraSqlPerso/${name}`);
  };
  ...
  postWebExtraSqlPersoTerminateByServiceNameAndName = (
    ...
    return this.ovh.request('POST', `/hosting/web/${serviceName}/extraSqlPerso/${name}/terminate`);
  };
  ...
  getWebFreedomByServiceNameAndDomain = (
    ...
    return this.ovh.request('GET', `/hosting/web/${serviceName}/freedom/${domain}`);
  };
  ...
  getWebLocalSeoAccountByServiceNameAndId = (
    ...
    return this.ovh.request('GET', `/hosting/web/${serviceName}/localSeo/account/${id}`);
  };
  ...
  getWebLocalSeoLocationByServiceNameAndId = (
    ...
    return this.ovh.request('GET', `/hosting/web/${serviceName}/localSeo/location/${id}`);
  };
  ...
  postWebModuleByServiceName = (
    ...
    return this.ovh.request('POST', `/hosting/web/${serviceName}/module`, body);
  };
  ...
  postWebModuleChangePasswordByServiceNameAndId = (
    ...
    return this.ovh.request('POST', `/hosting/web/${serviceName}/module/${id}/changePassword`);
  };
  ...
  getWebOvhConfigByServiceNameAndId = (
    ...
    return this.ovh.request('GET', `/hosting/web/${serviceName}/ovhConfig/${id}`);
  };
  ...
  postWebOvhConfigRollbackByServiceNameAndId = (
    ...
    return this.ovh.request('POST', `/hosting/web/${serviceName}/ovhConfig/${id}/rollback`, body);
  };
  ...
  createWebOwnLogsUserLogsByServiceNameAndId = (
    ...
    return this.ovh.request('POST', `/hosting/web/${serviceName}/ownLogs/${id}/userLogs`, body);
  };
  ...
  getWebOwnLogsUserLogsByServiceNameAndIdAndLogin = (
    ...
    return this.ovh.request('GET', `/hosting/web/${serviceName}/ownLogs/${id}/userLogs/${login}`);
  };
  ...
  postWebRequestByServiceName = (
    ...
    return this.ovh.request('POST', `/hosting/web/${serviceName}/request`, body);
  };
  ...
  postWebRequestBoostByServiceName = (
    ...
    return this.ovh.request('POST', `/hosting/web/${serviceName}/requestBoost`, body);
  };
  ...
  postWebRestoreSnapshotByServiceName = (
    ...
    return this.ovh.request('POST', `/hosting/web/${serviceName}/restoreSnapshot`, body);
  };
  ...
  postWebRuntimeByServiceName = (
    ...
    return this.ovh.request('POST', `/hosting/web/${serviceName}/runtime`, body);
  };
  ...
  updateWebRuntimeByServiceNameAndId = (
    ...
    return this.ovh.request('PUT', `/hosting/web/${serviceName}/runtime/${id}`, body);
  };
  ...
  createWebSslByServiceName = (
    ...
    return this.ovh.request('POST', `/hosting/web/${serviceName}/ssl`, body);
  };
  ...
  createWebUserByServiceName = (
    ...
    return this.ovh.request('POST', `/hosting/web/${serviceName}/user`, body);
  };
  ...
  updateWebUserByServiceNameAndLogin = (
    ...
    return this.ovh.request('PUT', `/hosting/web/${serviceName}/user/${login}`, body);
  };
  ...
  createWebUserLogsByServiceName = (
    ...
    return this.ovh.request('POST', `/hosting/web/${serviceName}/userLogs`, body);
  };
  ...
  getWebUserLogsByServiceNameAndLogin = (
    ...
    return this.ovh.request('GET', `/hosting/web/${serviceName}/userLogs/${login}`);
  };
  ...
  updateWebUserLogsByServiceNameAndLogin = (
    ...
    return this.ovh.request('PUT', `/hosting/web/${serviceName}/userLogs/${login}`, body);
  };
