...
import { VrackEligibleDedicatedServerInterfaces } from './VrackEligibleDedicatedServerInterfaces';

export type VrackEligibleServices = {
  ...
  dedicatedServerInterface?: VrackEligibleDedicatedServerInterfaces[] | null;
  ip?: string[] | null;
